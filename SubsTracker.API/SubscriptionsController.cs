...
public class SubscriptionsController(ISubscriptionService service, IMapper mapper) : ControllerBase
{
    [HttpGet("{id:guid}")]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return mapper.Map<SubscriptionViewModel>(getUpcomingBills);
    }
    ...
    [HttpPost]
    public async Task<SubscriptionViewModel> Create(Guid userId, CreateSubscriptionDto createDto, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<SubscriptionViewModel> Update(Guid id, UpdateSubscriptionDto updateDto, CancellationToken cancellationToken)
    { 
