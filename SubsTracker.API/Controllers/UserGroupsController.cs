    ...
    ) : ControllerBase
{
    ...
    /// <exception cref="ValidationException">Thrown if cannot find the user with that ID</exception>
    ...
    /// <exception cref="NotFoundException">Thrown if cannot find the UserGroup with that ID</exception>
    [HttpPut("{id:guid}")]
    ...
    /// <exception cref="ValidationException">Thrown if member already exists in this group</exception>
    [HttpPost("join")]
    ...
    /// </remarks>
    /// <returns>No content if successful</returns>
    /// <exception cref="NotFoundException">Thrown if member is not found in the group</exception>
    [HttpDelete("leave")]
    ...
    /// <exception cref="NotFoundException">Thrown if member is not found</exception>
    ...
    /// </remarks>
    /// <returns>The updated user group view model</returns>
    /// <exception cref="NotFoundException">Thrown if group or subscription is not found</exception>
